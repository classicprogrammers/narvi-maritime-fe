          ...
          <HStack spacing={4}>
            ...
            <VStack align="start" spacing={1}>
              ...
              <Text fontSize="sm" color="gray.500">
                Manage product and service groups
              </Text>
            </VStack>
          </HStack>
        </Flex>
        ...
        <Box px="25px">
          <Flex justify="space-between" align="center" py={4}>
            ...
            <HStack spacing={3}>
              ...
              <Text fontSize="sm" color="gray.600">
                Showing {startIndex + 1}-{Math.min(endIndex, filteredGroups.length)} of {filteredGroups.length} records
              </Text>
            </HStack>
      ...
      <Modal isOpen={isModalOpen} onClose={onModalClose} size="lg">
        ...
        <ModalContent>
          <ModalHeader bg="blue.600" color="white" borderRadius="md">
            <HStack spacing={3}>
              <Icon as={editingGroup ? MdEdit : MdAdd} />
              <Text>{editingGroup ? "Edit Group" : "Create New Group"}</Text>
            </HStack>
          </ModalHeader>
