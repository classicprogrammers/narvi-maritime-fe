        ...
        <Box pt={{ base: "130px", md: "80px", xl: "80px" }} overflow="hidden" position="relative" zIndex="122222">
            ...
            >
                <HStack spacing={{ base: "2", md: "4" }} flexWrap="wrap">
                    {["Inventory", "Overview", "Operations", "Products", "Shipment", "Agents", "Reporting", "Configuration"].map((item, index) => (
                        <Text
                            key={item}
                ...
                <HStack spacing={{ base: "2", md: "4" }} flexWrap="wrap" justify="flex-end">
                    <IconButton
                        size="sm"
                        icon={<Icon as={MdBugReport} color="white" />}
                        variant="ghost"
                        aria-label="Issues"
                    ...
                    <Box position="relative">
                        <IconButton
                            size="sm"
                            icon={<Icon as={MdChat} color="white" />}
                            variant="ghost"
                            aria-label="Messages"
                    ...
                    <Box position="relative">
                        <IconButton
                            size="sm"
                            icon={<Icon as={MdAccessTime} color="white" />}
                            variant="ghost"
                    ...
                    <Text fontSize={{ base: "xs", md: "sm" }} color="white" fontWeight="medium" display={{ base: "none", lg: "block" }}>
                        My Company (San Francisco)
                    </Text>
                    <HStack spacing="2">
                        <Icon as={MdPerson} w="24px" h="24px" color="white" />
